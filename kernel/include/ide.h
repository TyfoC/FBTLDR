...
#define IDE_TRANSFER_STATUS_WRONG_DEVICE			0xFC
#define IDE_TRANSFER_STATUS_NO_DEVICE				0xFD
#define IDE_TRANSFER_STATUS_NO_LBA					0xFE
...
#define IDE_ATA_MAX_SECTORS_PER_OPERATION			0xFF
#define IDE_ATAPI_MAX_SECTORS_PER_OPERATION			0x01
#define IDE_ATA_MAX_TRANSFER_SIZE_PER_OPERATION		0x1FE00
#define IDE_ATAPI_MAX_TRANSFER_SIZE_PER_OPERATION	0x800

#define IDE_PRIMARY_IRQ								0x0E
#define IDE_SECONDARY_IRQ							0x0F

#define IDE_ATA_SECTOR_SIZE							0x200
#define IDE_ATAPI_SECTOR_SIZE						0x800
#define IDE_ATA_WORDS_PER_SECTOR					0x100
#define IDE_ATAPI_WORDS_PER_SECTOR					0x400
...
UINT8 IDEATAPIWriteSector(SIZE_T ctrlIndex, SIZE_T devIndex, VOID* source, UINT32 lba);
